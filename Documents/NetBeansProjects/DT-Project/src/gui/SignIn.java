...
public class SignIn extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/signInImage.jpg"))); // NOI18N

        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/close (7).png"))); // NOI18N
        ...
        jTextField1.setText("Daham Bandara");
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/right (2).png"))); // NOI18N
        jLabel5.setText("All rights reserved by Immortals");
            ...
            try {
                ...
                if (resultSet.next()) {
                    if (resultSet.getString("status.status").equals("Active")) {
                        ...
                        userBean.setUserType(resultSet.getString("user_type.type"));
